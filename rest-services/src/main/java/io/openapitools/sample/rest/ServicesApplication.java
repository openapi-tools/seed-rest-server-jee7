package io.openapitools.sample.rest;
...
import io.openapitools.sample.rest.bank.account.exposure.rs.AccountEventFeedMetadataServiceExposure;
...
import io.openapitools.sample.rest.bank.account.exposure.rs.ReconciledTransactionServiceExposure;
import io.openapitools.sample.rest.bank.account.exposure.rs.TransactionServiceExposure;
import io.openapitools.sample.rest.bank.customer.exposure.rs.CustomerEventFeedMetadataServiceExposure;
import io.openapitools.sample.rest.bank.customer.exposure.rs.CustomerEventServiceExposure;
import io.openapitools.sample.rest.bank.customer.exposure.rs.CustomerServiceExposure;
import io.openapitools.sample.rest.common.rs.JaxRsRuntime;
 ...
 */
@SwaggerDefinition(
    host = "sample.services.sample.openapitools.io",
    basePath = "/sample",
    ...
    tags = {@Tag(name = "select", description = "select is an api capability see doc " +
        "on https://github.com/openapi-tools/api-capabilities/blob/master/README.md"),
    ...
    externalDocs = @ExternalDocs(value = "documentation",
        url = "https://github.com/openapi-tools/api-capabilities/blob/master/README.md")
    )
